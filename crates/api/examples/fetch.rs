...
//! one written by `truthsocial-api setup`).
//!
//! ```text
...
//! the `TRUTHSOCIAL_CLIENT_ID`, `TRUTHSOCIAL_CLIENT_SECRET`, `TRUTHSOCIAL_USERNAME`, and
//! `TRUTHSOCIAL_PASSWORD` environment variables.

use std::path::PathBuf;

use truthsocial_api::auth::Credentials;
use truthsocial_api::client::Client;
use truthsocial_api::config::Config;
use truthsocial_api::types::TimelineParams;
...
/// Remove tags and collapse whitespace for a preview. HTML entities are left unchanged.
