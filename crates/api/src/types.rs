...
impl TimelineParams {
    ...
    /// Requested maximum number of results. The client sends this value without validation.
    #[must_use]
...
///
/// Lists omitted from the response default to empty. Unknown top-level fields are ignored.
...
pub struct SearchResults {
    ...
    /// Matching groups, which may include a search [`position`](Group::position).
    #[serde(default)]
